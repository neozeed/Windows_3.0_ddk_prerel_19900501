...
VDD_Str_CheckVidPgs DB	"Cannot run Windows because of video device conflict;", 0Dh, 0Ah, 0Dh, 0Ah
		    DB	"run Setup again",0
...
VDD_Str_BadDevice   DB	"Video initialization failed;", 0Dh, 0Ah, 0Dh, 0Ah
		    DB	"run Setup again",0
...
VMB_Str_NoMainMem   DB	"This application has insufficient memory for its "
		    DB	"display.  "
		    DB	"Check the PIF settings to ensure they are correct.  "
		    DB	"If the display is erratic, restart the application.",0
...
VMB_Str_NoCopyMem   DB	"This application has insufficient memory for its "
		    DB	"display.  As a result, the display may be updated "
		    DB	"incorrectly.  Close one or more applications to increase "
		    DB	"available memory and "
		    DB	"check the PIF settings to ensure they are correct.",0
...
VMB_Str_Exclusive   DB	"You cannot run this application in a window or in "
		    DB	"the background.  "
		    DB	"You can display it in a window, but it will be "
		    DB	"suspended until you run it full screen.  "
		    DB	"Check the PIF settings to ensure they are correct.",0
...
VMB_Str_NotWindow   DB	"You cannot display this application in a window "
		    DB	"or run it in the background.  "
		    DB	"It will be suspended until you display it full screen.  "
		    DB	"Check the PIF settings to ensure they are correct.",0
...
VMB_Str_NoSupMode   DB	"This application will be suspended until you run it "
		    DB	"full screen.  "
		    DB	"Check the PIF settings to ensure they are correct.  "
		    DB	"If you need to restore the display, restart the application.",0
...
VMB_Str_NoFGrnd     DB	"You cannot run this application while other "
		    DB	"high-resolution applications are running full screen.  "
		    DB	"The application will be suspended until a low-resolution or "
		    DB	"text application is running full screen.  "
		    DB	"Check the PIF settings to ensure they are correct.",0
