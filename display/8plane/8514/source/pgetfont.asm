...
externW OldFontSize			;in STRBLT.ASM
...
;crash the board!
	...
	cmp	ax, 192 		;is it a huge font?
	ja	short LFMegaFont	;just return an error in that case
...
NewFontFits:
	...
	mov	LastChar, al
ifdef	_PMODE
	push	fs			;or else KERNEL shits bricks
