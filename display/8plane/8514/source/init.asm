...
externW OldFontSize			;in TEXTOUT.ASM
...
;are returning to Windows running in the OS/2 compatibility box.
	...
	mov	OldFontSize, ax
	mov	BigOldFontSize, ax
	mov	OldFontHeight, ax
	mov	BigOldFontHeight, ax
