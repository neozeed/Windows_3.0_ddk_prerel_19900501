...
cBegin
	WriteAux <'Output'>
;
; remove the generated stack frame. The routines will re-generate them
;
	mov	cx,ds			; cx holds the data s
	pop	ds			; toss out ds; this keeps ds fixup
	pop	bp			; restore bp to pre-call state
	dec	bp
;
        mov     bx,sp
	...
	cmp	ax,OS_BEGINNSCAN	;Is this a scanline ?
        je      dispatch_scanlines
	cmp	ax,OS_ENDNSCAN		;Is this a scanline ?
