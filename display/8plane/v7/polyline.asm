...
ifdef   EXCLUSION
        ...
        externFP far_set_bank_select    ; Set VRAM VGA memory bank
...
BYTES_PER_LINE  equ     SCREEN_W_BYTES
...
cProc   do_polylines,<FAR,PUBLIC,WIN,PASCAL>,<es,ds,si,di>
...
stack_space_ok:
	...
	mov	ds,cx			; cx holds our data segment
...
calculate_for_screen:
	...
	mov	bank_select,dl		; initialize current bank
        mov     TempBank,dl
        call    far_set_bank_select     ; initialize the bank select stuff
