...
;	 mov	 di,DataOFFSET device_local_brush
;	 mov	 al,es:[di]		 ; get the 1st pixel
;	 pop	 di
	lodsb
...
;
	...
	add	di,SCREEN_W_BYTES	; go to the next scan
...
;
; History:
;    Wed 2/1/89 -by- David D. Miller, Video Seven Inc.
;    Created it.
;
;---------------------------------------------------------------------------

VERTICAL_RETRACE_ACTIVE EQU     8
...
; update ramdac
	...
	mov	si,word PTR lpPalette	; get pointer to table
