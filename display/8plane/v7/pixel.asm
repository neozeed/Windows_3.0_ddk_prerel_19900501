...
;               . 256 color bit maps
; -by- Video 7 DSC        Wed 25-Jan-1988
...
sEnd    Data
        ...
        externFP far_set_bank_select    ; routine to setup video h/w
...
;
        ...
        adc     dl,dh
        call    far_set_bank_select     ; perform the video h/w bank select
;
        mov     si,ax                   ; SI is offset of the color pixel
