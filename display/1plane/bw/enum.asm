...
brush_colors label byte
	...
	dw	000h			;Black brush color
	dw	040h			;DkGrey brush color
	dw	080h			;Grey brush color
	dw	0C0h			;LtGrey brush color
	dw	0FFh			;White brush color
...
;	brushes, the background color is not enumerated.
	...
	mov	obj_area.lbStyle,dx		;Set brush style
	errnz	BS_HATCHED-2			;2 is in DX
