...
HDEVOBJECT FAR PASCAL GetDeviceObjects(HDC,WORD);
HDEVOBJECT FAR PASCAL FreeDeviceObjects(HDEVOBJECT);
int        FAR PASCAL SetCurrentObject(HDEVOBJECT,short);
int        FAR PASCAL GetCurrentObject(HDEVOBJECT);
int        FAR PASCAL GetObjectCount(HDEVOBJECT);
BOOL       FAR PASCAL CopyDeviceObject(LPSTR,HDEVOBJECT);
HANDLE     FAR PASCAL CreateDeviceObject(HDEVOBJECT);
int        FAR PASCAL AddObject(HDEVOBJECT,LPSTR);
int        FAR PASCAL RemoveObject(HDEVOBJECT);
...
\*---------------------------------------------------------------------------*/
unsigned FAR PASCAL lrand(LPINT);
unsigned FAR PASCAL lsrand(LPINT,unsigned);
LPSTR    FAR PASCAL litoa(int,LPSTR,int);
int      FAR PASCAL latoi(LPSTR);
LPSTR    FAR PASCAL ReverseString(LPSTR);
int      FAR PASCAL BitCountWord(WORD);
int      FAR PASCAL BitCountDWord(DWORD);
void     FAR PASCAL WEP(WORD);
...
int  FAR PASCAL EnumTests(LPTEST,WORD,FARPROC,LPSTR);
BOOL FAR PASCAL ExecuteTest(HWND,HDC,LPTEST);
BOOL FAR PASCAL KillTest(LPTEST);
BOOL FAR PASCAL OutputTestLog(LPSTR,LPTEST,WORD,WORD);
BOOL            SetTestEnvironment(HWND,HDC,LPTEST);
BOOL            RestoreTestEnvironment(HWND,HDC,LPTEST);
BOOL            OutputDebugTest(LPTEST,LPSTR);
...
typedef struct tagSCREENFILEHEADER
{
     WORD  wScreens;
     WORD  wDIBFormat;
} SCREENFILEHEADER;
typedef SCREENFILEHEADER      *PSCREENFILEHEADER;
typedef SCREENFILEHEADER NEAR *NPSCREENFILEHEADER;
typedef SCREENFILEHEADER FAR  *LPSCREENFILEHEADER;

typedef struct tagSCREENS
{
     DWORD dwFileSize;
     WORD  wScreenTotal;
     WORD  wScreenImage;
...
typedef SCREENS      *PSCREENS;
typedef SCREENS NEAR *NPSCREENS;
typedef SCREENS FAR  *LPSCREENS;

VOID   FAR PASCAL ClearScreen(HWND);
HANDLE FAR PASCAL LoadScreen(int,int);
int    FAR PASCAL SaveScreen(HANDLE,LPSTR);
HANDLE FAR PASCAL CaptureScreen(HWND,HDC);
BOOL   FAR PASCAL CompareScreens(HANDLE,HANDLE);
...
BOOL FAR PASCAL GetDeviceInfo(HWND,LPDEVINFO);
...
HDC FAR PASCAL GetPrinterDC(HWND,LPSTR);
...
\*---------------------------------------------------------------------------*/
BOOL FAR PASCAL TstExtTextOutRect(HDC,short,LPRECT,LPSTR,short,LPINT);
