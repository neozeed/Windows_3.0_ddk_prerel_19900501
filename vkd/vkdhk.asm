...
chkhk_1:
	...
	test	[VKD_flags], VKDf_HK_hold   ;Q: already in hot key state?
	je	short don_t_check	    ;	N: don't enter hot key state
					    ;	   on just the release!
...
new_hk:
	...
	call	Hot_Key_Notify
	and	[VKD_flags], NOT VKDf_HK_hold; release from hold state
	pop	ebx

no_complete_notify:
	pop	ecx
	or	[VKD_flags], VKDf_HK_hold   ; flag special hot key state
...
IFDEF Schedule_Priority_on_Owner_VM
	...
	test	[ebx.CB_VM_Status], VMStat_Not_Executeable OR VMStat_Suspended
...
BeginProc VKD_PriorityNotify
	...
	and	[VKD_flags], NOT VKDf_HK_event
