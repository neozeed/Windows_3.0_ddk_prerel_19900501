...
externW		CSAlias				; writable alias for CODE seg.
						; (from ENABLE.ASM)
...
LoadOemAnsi:
	...
	jne	NTOemClose
					...
					; BX is still handle
	mov	dx,CODEoffset CodePage	; read starting at Code Page entry
	mov	ax,CSAlias		; get writable alias for CS
	push	ds			; save DS
...
;;	jcxz	MapVKNotFound			; (always nonzero, in fact)
	...
	jne	MapVKNotFound			; if not =,  return 0
