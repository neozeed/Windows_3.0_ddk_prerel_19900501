...
; 28 July 88    magnusa Changed to be an Islandic driver
;
...
keyTranslationTable label byte		; ****** end insert 5
	...
	DB	VK_9      	; 0ah 10
	DB	VK_0      	; 0bh 11
        DB      VK_OEM_5        ; o umlaut Changed magnusa
        DB      VK_OEM_MINUS    ; -        Changed magnusa
	DB	VK_BACK   	; 0eh 14
	DB	VK_TAB    	; 0fh 15
	DB	VK_Q      	; 010h 16
	DB	VK_W      	; 011h 17
	...
	DB	VK_O      	; 018h 24
	DB	VK_P      	; 019h 25
        DB      VK_OEM_4        ; d striked  Changed magnusa
	DB	VK_OEM_1    	; 01bh 27
...
X1	label byte	; swap for AT
        DB      VK_OEM_PLUS     ; 029h 41       Changed magnusa
	DB	VK_SHIFT  	; 02ah 42
X2	label byte	; swap for AT
	...
	DB	VK_OEM_PERIOD	; 034h 52
        DB      VK_OEM_7        ; 035h 53       Changed magnusa
	DB	VK_SHIFT  	; 036h 54
...
AsciiTable label byte		; *********** end insert 6
	...
	DB	VK_0      ,	'0',  	'=',  	-1
	DB	VK_1      ,	'1',  	'!',  	-1
        DB      VK_2      ,     '2',    '"',    0 +80h ;Changed magnusa
	DB	VK_3      ,	'3',  	'#',  	-1
	DB	VK_4      ,	'4',  	0a4h,	-1
	DB	VK_5      ,	'5',  	025h,	-1
	DB	VK_6      ,	'6',  	'&',  	01eh + 80h
	...
	DB	VK_DECIMAL,	'.',  	'.',  	-1
	DB	VK_DIVIDE ,	'/',  	'/',  	-1
        DB      VK_OEM_1    ,   '_',    '?',    01dh    ;Changed magnusa
	DB	VK_OEM_2    ,	'<',  	'>',  	01ch
        DB      VK_OEM_3    ,   0e6h,   0A8h,   -1      ;Changed magnusa
        DB      VK_OEM_4    ,   0F0h,   0D0h,   01bh    ;Changed magnusa
        DB      VK_OEM_5    ,   0F6h,   0D6h,   -1      ;Changed magnusa
        DB      VK_OEM_6    ,   0E6h,   0C6h,   -1      ;Changed magnusa
        DB      VK_OEM_7    ,   0FEh,   0DEh,   -1      ;Changed magnusa
	DB	VK_OEM_8    ,	-1,   	-1,   	-1
...
CtrlAltTable label byte		; **************** end insert 9
	...
	; CtrlAltTable
        DB      VK_2      ,     '@',    '@'
        DB      VK_3      ,     0A3h,   0A3h    ;Changed magnusa
        DB      VK_6      ,     '^',    '^'     ;Changed magnusa
	DB	VK_7      ,	'&',	-1
	DB	VK_8      ,	'*',	-1
	DB	VK_9      ,	'(',	-1
	DB	VK_0      ,	')',	-1
        DB      VK_OEM_PLUS ,   '`',    '~'     ;Changed magnusa
	DB	VK_OEM_4    ,	'=',	'+'
	DB	VK_OEM_6    ,	'[',	'{'
	DB	VK_OEM_1    ,	']',	'}'
        DB      VK_OEM_3    ,   '=',    '+'     ;Changed magnusa
        DB      VK_OEM_7    ,   ']',    '}'     ;Changed magnusa
        DB      VK_OEM_5    ,   ';',    ':'     ;Changed magnusa
	DB	VK_OEM_2    ,	'\',	'|'
        DB      VK_OEM_COMMA,   '@',    '@'     ;Changed magnusa
        DB      VK_OEM_PERIOD,  '^',    '^'     ;Changed magnusa
	DB	VK_OEM_MINUS,	'/',	'?'
        DB      VK_A    ,       0E5h,   0C5h    ;Changed magnusa
        DB      VK_O    ,       0F8h,   0D8h    ;Changed magnusa
...
TavoloMorto label byte		; ****************** end insert 10
	...
	; TavoloMorto
        DB      VK_OEM_3    ,   shift_1, acute  ;Changed magnusa
        DB      VK_OEM_3    ,   shift_2, umlaut ;Changed magnusa
