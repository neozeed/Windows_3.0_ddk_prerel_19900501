...
;
; history
; long ago	plb	manually edited: VK_OEM_5 is 1/2 character
; 12 jan 88	plb	Add 80h to some control codes.
; 28 Jul 88     magnusa Changed to be a Islandic keyboard driver
;  4 Apr 89     fgd     Fix some bugs for 2.11 timeframe
;
...
db	'OLIKB2.03'	; key to identify table -- DON'T CHANGE THIS !!
...
AsciiTable label byte		; *********** end insert 6
	...
	DB	VK_2      ,	'2',  	'"',  	-1
	DB	VK_3      ,	'3',  	'#',  	-1
        DB      VK_4      ,     '4',    024h,   -1      ;Changed magnusa
	DB	VK_5      ,	'5',  	025h,	-1
        DB      VK_6      ,     '6',    '&',    01eh + 80h
	DB	VK_7      ,	'7',  	'/',  	-1
	DB	VK_8      ,	'8',  	'(',  	-1
	...
	DB	VK_DECIMAL,	',',  	',',  	-1
	DB	VK_DIVIDE ,	'/',  	'/',  	-1
        DB      VK_OEM_1    ,   027h,   '?',    01dh    ;Changed magnusa
        DB      VK_OEM_2    ,   '+',    '*',    -1      ;Changed magnusa
	DB	VK_OEM_3    ,	0e6h,	0c6h,	-1
        DB      VK_OEM_4    ,   '-',    '_',    -1      ;Changed magnusa
        DB      VK_OEM_5    ,   0B0h,   0a8h,   01ch    ;Changed magnusa
        DB      VK_OEM_6    ,   0f0h,   0d0h,   01bh    ;Changed magnusa
        DB      VK_OEM_7    ,   027h,   027h,   -1      ;Changed magnusa BUGBUG
	DB	VK_OEM_8    ,	-1,   	-1,   	-1
        DB      VK_OEM_PLUS ,   0f6h,   0d6h,   -1      ;Changed magnusa
	DB	VK_OEM_COMMA,	',',  	';',  	-1
        DB      VK_OEM_MINUS,   0feh,   0deh,   01fh    ;Changed magnusa
	DB	VK_OEM_PERIOD,	'.',  	':',  	-1
	DB	VK_OEM_102,	'<',  	'>',  	01ch
...
CtrlAltTable label byte		; **************** end insert 9
	...
	DB	VK_OEM_1    ,	'~',	-1
        DB      VK_OEM_2    ,   '`',    -1      ;Changed magnusa
        DB      VK_OEM_5    ,  0b0h,   0a8h     ;fgd
        DB      VK_OEM_7    ,   '^',    -1      ;Changed magnusa
        DB      VK_Q      ,     '@',    -1
	DB	VK_M      ,	0b5h,	-1
        DB      VK_OEM_102,     '|',    -1      ;Changed magnusa
        DB      VK_OEM_PLUS,    '\',    -1      ;Changed magnusa
...
TavoloMorto label byte		; ****************** end insert 10
	...
	; TavoloMorto
        DB      VK_OEM_7    ,   shift_1, acute
        DB      VK_OEM_7    ,   shift_5, circumflex
        DB      VK_OEM_5    ,   shift_1, tilde
        DB      VK_OEM_5    ,   shift_2, umlaut
        DB      VK_OEM_2    ,   shift_5, grave
