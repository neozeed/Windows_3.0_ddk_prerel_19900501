...
;
; The Oem2Ansi and Ansi2Oem tables are included here.
;
; ************************************* end insert 4
...
DeadKeyDefLabel label byte 				; ** begin insert 8
	db	-1,  -1  , -1  , -1  , -1  , -1
