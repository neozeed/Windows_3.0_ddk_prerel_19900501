...
ifdef EXTENDEDANSI
	...
	mov	bx,CODEoffset AnsiToOemTable-128	; get table offset
	jmp	short oa0		; in this case, code is same as
	...
	; characters >= 160 only).
	;
	mov	bx,CODEoffset AnsiToOemTable-160	; get table offset
	jmp	short ao1
...
cBegin	OemToAnsi
	...
	mov	bx,CODEoffset OemToAnsiTable-128	; get table offset
...
ifdef EXTENDEDANSI
	...
	mov	bx,CODEoffset AnsiToOemTable-128	; get table offset
	jmp	short aob1		; in this case, code is same as
					; OemToAnsi() except for translation
					; tables used.
